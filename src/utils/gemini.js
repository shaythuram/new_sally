...
// macOS audio process variable removed - Windows only implementation
let messageBuffer = '';
...
// macOS audio capture functions removed - Windows only implementation
...
// macOS audio stop function removed - Windows only implementation
...
function setupGeminiIpcHandlers(geminiSessionRef) {
    ...
    // Image sending disabled - only audio processing enabled
    ipcMain.handle('send-image-content', async (event, { data, debug }) => {
        console.log('Image sending disabled - only audio will be sent to Gemini');
        return { success: false, error: 'Image sending disabled' };
    });
    ...
    // macOS audio capture IPC handlers removed - Windows only implementation

    ipcMain.handle('close-session', async event => {
        try {
            // macOS audio cleanup removed - Windows only implementation
...
module.exports = {
    ...
    // macOS audio functions removed - Windows only implementation
    // macOS audio functions removed - Windows only implementation
    convertStereoToMono,
    // macOS audio functions removed - Windows only implementation
    sendAudioToGemini,
